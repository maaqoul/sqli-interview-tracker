    ...
    <aside class="w-64 bg-sqli-midnight text-white p-6 flex flex-col shrink-0">
      ...
      <nav class="space-y-2 text-sm flex-1">
        ...
        <router-link
          to="/my-interviews"
          class="block px-3 py-2 rounded-lg transition-colors"
          :class="isActive('/my-interviews') ? 'bg-white/10 text-white' : 'text-white/60 hover:text-white hover:bg-white/5'"
        >
          My Interviews
        </router-link>
        <router-link
          to="/ai"
          class="block px-3 py-2 rounded-lg transition-colors"
          :class="isActive('/ai') ? 'bg-white/10 text-white' : 'text-white/60 hover:text-white hover:bg-white/5'"
        >
          AI Tools
        </router-link>
      </nav>
